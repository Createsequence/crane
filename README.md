...
![qq群](https://img.shields.io/badge/qq%E7%BE%A4-540919540-yellowgreen) ![CRANE](https://img.shields.io/github/license/Createsequence/crane) ![springboot](https://img.shields.io/badge/springboot-2.3.4.RELEASE-red)  ![maven--central](https://img.shields.io/badge/maven--central-0.6.1-green)
...
- [x] ~~允许通过多个 key 字段获取数据源；~~

- [x] ~~允许通过专门的配置类或配置文件配置字段映射模板；~~

- [x] ~~允许通过专门的配置类或配置文件配置操作；~~
