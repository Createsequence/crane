...
public class PropertyUtils {
    ...
    private static final TableMap<Class<?>, String, PropertyCache> CACHE_TABLE = new BaseTableMap<>(
     ...
     * @date 2022/4/1 13:50
     */
    public static Optional<PropertyCache> getPropertyCache(Class<?> targetClass, String fieldName) {
        Map<String, PropertyCache> cacheMap = CACHE_TABLE.computeIfAbsent(targetClass,t -> new ConcurrentHashMap<>());
        return Optional.ofNullable(
            cacheMap.computeIfAbsent(fieldName, fn -> createPropertyCache(targetClass, fieldName))
        );
    }
     ...
     */
    @Nullable
    private static PropertyCache createPropertyCache(Class<?> targetClass, String fieldName) {
        ...
        return new PropertyCache(targetClass, field, getter, setter);
    }
