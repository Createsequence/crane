...
public class ClassAnnotationConfigurationParser
     ...
     * @param operations 注解
     * @return java.util.List<interfaces.parser.io.github.createsequence.crane.core.AssembleOperation>
     * @author huangchengxing
     ...
     * @return java.util.List<interfaces.parser.io.github.createsequence.crane.core.DisassembleOperation>
     * @author huangchengxing
