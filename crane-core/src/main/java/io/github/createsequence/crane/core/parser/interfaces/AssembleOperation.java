...
public interface AssembleOperation extends Operation {
     ...
     * 获取装配器
     *
     * @return io.github.createsequence.crane.operator.interfaces.Assembler
     * @author huangchengxing
     * @date 2022/3/1 15:57
     */
     ...
     * 获取装配容器
     *
     * @return io.github.createsequence.crane.container.Container
     * @author huangchengxing
     * @date 2022/3/1 15:56
     */
     ...
     * 获取装配配置字段
     *
     * @return java.util.List<io.github.createsequence.crane.parse.interfaces.PropertyMapping>
     * @author huangchengxing
     * @date 2022/3/1 16:02
     */
